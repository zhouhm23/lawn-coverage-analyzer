...
```csv
实验序号,指标,A (LiDAR+原始),B (视觉+原始),C (视觉+改进)
1,区域覆盖率,66.05%,76.02%,86.70%
,碰撞次数,8,2,0
,重复覆盖率,48.15%,36.7,15.10%
,轨迹长度m,31.86,29.01,18.19
,运行时长s,858,606.9,524.3
2,区域覆盖率,,,
,碰撞次数,,,
,重复覆盖率,,,
,轨迹长度m,,,
...
python run_camera_coverage.py --video camera_record06241502.mp4 --mask mask_camera_record06241502.png --calib-frames 1 --export-overlay
```
